...
import { getObjectStorageEnv } from '../../config/runtime-env'
...
export interface PrivateObjectStorage {
  ...
  readonly get: (objectKey: string) => Promise<PrivateObject | null>
  readonly remove: (objectKey: string) => Promise<void>
}

let bucketReady: Promise<void> | null = null

export const createS3PrivateObjectStorage = (): PrivateObjectStorage => {
