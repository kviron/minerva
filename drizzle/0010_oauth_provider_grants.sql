...
CREATE TABLE "oauth_grants" (
	...
	CONSTRAINT "oauth_grants_status_check" CHECK ("oauth_grants"."status" in ('active', 'revoked')),
	CONSTRAINT "oauth_grants_resource_check" CHECK ("oauth_grants"."resource" = btrim("oauth_grants"."resource") and char_length("oauth_grants"."resource") between 1 and 2048),
	CONSTRAINT "oauth_grants_revocation_check" CHECK (
    ("oauth_grants"."status" = 'active' and "oauth_grants"."revoked_at" is null)
    or ("oauth_grants"."status" = 'revoked' and "oauth_grants"."revoked_at" is not null)
  )
);
--> statement-breakpoint
...
ALTER TABLE "oauth_grants" ADD CONSTRAINT "oauth_grants_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "oauth_grants" ADD CONSTRAINT "oauth_grants_client_id_oauth_client_client_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."oauth_client"("client_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "oauth_grants_active_subject_unique" ON "oauth_grants" USING btree ("user_id","client_id","resource") WHERE "oauth_grants"."status" = 'active';--> statement-breakpoint
CREATE INDEX "oauth_grants_user_id_idx" ON "oauth_grants" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "oauth_grants_client_id_idx" ON "oauth_grants" USING btree ("client_id");--> statement-breakpoint
CREATE INDEX "oauth_grants_status_idx" ON "oauth_grants" USING btree ("status");--> statement-breakpoint
