...
A centered shadcn card contains email, password, sign-in action, locale selection, and theme control. Public registration is absent. Password recovery belongs to the full MVP route set but remains outside this eight-screen prototype flow.
