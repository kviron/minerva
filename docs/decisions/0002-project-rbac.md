...
- A Project Admin may invite a new user only into a project they administer, with the initial project role fixed on the invitation.
- Accepting a project-bound invitation creates or activates the account and membership atomically and grants no global administrative privilege.
