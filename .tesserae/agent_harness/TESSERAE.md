...
- **Minerva MVP Blueprint** (`CommunitySummary`) — Designs, implementation plans, and progress notes for Minerva's MVP navigation, identity, project management, route structure, and UI foundations.
