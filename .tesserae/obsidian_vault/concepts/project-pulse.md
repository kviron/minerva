...
- summarizes → [[adr-0015-allow-permanent-discard-only-for-never-published-document-branches]]
...
- summarizes → [[create-a-child-document-from-the-tree-plan]]
...
- summarizes → [[document-archive-and-restore-plan]]
- summarizes → [[document-images-implementation-plan]]
- summarizes → [[document-internal-links-and-backlinks-plan]]
- summarizes → [[document-publication-history-and-restore-plan]]
- summarizes → [[document-tree-move-and-reorder-plan]]
...
- summarizes → [[permanently-discard-never-published-documents-plan]]
